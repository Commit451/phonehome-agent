...
export class PairingRequiredError extends PhoneHomeError {
    constructor(status) {
        super('pairing_required', 'This agent no longer matches the active PhoneHome device. Tell the user to open ' +
            'PhoneHome > Setup, copy the new pairing code, and update this agent with `phone-home setup`.', {
            details: {
                action: 'request_new_pairing_code',
                userMessage: 'Open PhoneHome > Setup on the active phone and copy the new agent pairing code.',
