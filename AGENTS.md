...
- Keep the GitHub source repository private while publishing `@commit451/phonehome` as a public npm package; npm provenance must remain disabled while the source is private.
